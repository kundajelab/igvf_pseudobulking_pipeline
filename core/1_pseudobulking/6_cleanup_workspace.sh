...
rm -f "${basedir}/step1_complete.txt"
rm -f "${basedir}/step2_complete.txt"
rm -f "${basedir}/step3_complete.txt"
rm -f "${basedir}/step4_complete.txt"
rm -f "${basedir}/step5_complete.txt"